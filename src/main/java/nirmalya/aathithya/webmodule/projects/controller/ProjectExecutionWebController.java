...
public class ProjectExecutionWebController {
	...
	@PostMapping("/project-execution-save-year")
	...
	@SuppressWarnings("unchecked")
	@PostMapping("/project-execution-get-year-list")
	...
	@SuppressWarnings("unchecked")
	@PostMapping("/project-execution-get-cc-list")
	...
	@SuppressWarnings("unchecked")
	@PostMapping("/project-execution-save")
